...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-blue-500 to-violet-500 text-white shadow-lg shadow-blue-500/25 hover:from-blue-400 hover:to-violet-400 hover:shadow-blue-500/40 hover:-translate-y-0.5",

        gold:
          "bg-gradient-to-r from-[#F8E27A] via-[#D4AF37] to-[#B8860B] text-[#0B1F4D] shadow-lg shadow-yellow-500/30 hover:from-[#FFE78C] hover:via-[#E5C14A] hover:to-[#C99500] hover:shadow-yellow-500/50 hover:-translate-y-0.5",
